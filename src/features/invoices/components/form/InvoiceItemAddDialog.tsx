...
const InvoiceItemAddDialog = ({ isOpen, onClose, onSave, initialItem }: InvoiceItemDialogProps) => {
  ...
  return (
    <BaseDialog isOpen={isOpen} onClose={onClose} title={initialItem ? 'Edit Item' : 'Add Item'}>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          handleSave();
